...
extern const uint32_t Person_PersonType_internal_data_[];
constexpr Person_PersonType Person_PersonType_PersonType_MIN = static_cast<Person_PersonType>(0);
constexpr Person_PersonType Person_PersonType_PersonType_MAX = static_cast<Person_PersonType>(0);
constexpr int Person_PersonType_PersonType_ARRAYSIZE = 0 + 1;
const ::google::protobuf::EnumDescriptor*
Person_PersonType_descriptor();
template <typename T>
const std::string& Person_PersonType_Name(T value) {
  static_assert(std::is_same<T, Person_PersonType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to PersonType_Name().");
  return Person_PersonType_Name(static_cast<Person_PersonType>(value));
}
template <>
inline const std::string& Person_PersonType_Name(Person_PersonType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<Person_PersonType_descriptor,
                                                 0, 0>(
      static_cast<int>(value));
}
inline bool Person_PersonType_Parse(absl::string_view name, Person_PersonType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Person_PersonType>(
...
/* @@protoc_insertion_point(class_definition:skDB.Person) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "skDB.Person"; }
 ...
 public:
  ...
  // nested types ----------------------------------------------------
  using PersonType = Person_PersonType;
  static constexpr PersonType STUDENT = Person_PersonType_STUDENT;
  static inline bool PersonType_IsValid(int value) {
    return Person_PersonType_IsValid(value);
  }
  static constexpr PersonType PersonType_MIN = Person_PersonType_PersonType_MIN;
  static constexpr PersonType PersonType_MAX = Person_PersonType_PersonType_MAX;
  static constexpr int PersonType_ARRAYSIZE = Person_PersonType_PersonType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor* PersonType_descriptor() {
    return Person_PersonType_descriptor();
  }
  template <typename T>
  static inline const std::string& PersonType_Name(T value) {
    return Person_PersonType_Name(value);
  }
  static inline bool PersonType_Parse(absl::string_view name, PersonType* value) {
...
template <>
struct is_proto_enum<::skDB::Person_PersonType> : std::true_type {};
template <>
